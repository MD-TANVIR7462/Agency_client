...
const SubHero = ({ heroTittle, subHeroTittle }: { heroTittle?: string; subHeroTittle?: string }) => {
  return (
    <section className="relative  sm:h-[500px] max-h-[500px]  overflow-hidden bg-gradient-to-b from-gray-900 via-purple-900 to-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <MotionWraper initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-300">{subHeroTittle ? subHeroTittle : ""}</p>
          <div className="mt-8">
            <SubBannerButton />
          </div>
        </MotionWraper>

        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700 hover:border-purple-400 transition-all duration-300">
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              efficiency, and competitive advantage. We strive to deliver exceptional value 
          ...
          <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700 hover:border-purple-400 transition-all duration-300">
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              our innovative solutions, technical excellence, and commitment to client success. 
              We aim to shape the future of technology while maintaining the highest standards 

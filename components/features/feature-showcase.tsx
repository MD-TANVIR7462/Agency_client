    ...
    <div className="grid gap-12 lg:grid-cols-2 lg:gap-8">
      ...
      <motion.div
        ...
        <p className="mt-4 text-lg text-gray-400">
          ...
          enterprise solutions, designed to scale with your needs.
        </p>
        ...
        <div className="mt-8">
          <Link href="/About">
            {" "}
            <button className="rounded-lg bg-gradient-to-r from-purple-500 to-blue-500 px-8 py-3 text-white transition-opacity hover:opacity-90">
              Learn More
            </button>
          </Link>
        </div>

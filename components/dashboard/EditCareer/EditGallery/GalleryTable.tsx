    ...
    <div className="w-full overflow-x-auto bg-gray-900/50 rounded-lg shadow-xl text-sm ring-1 ring-purple-500/20">
      <table className="w-full border-collapse">
        ...
        <tbody className="divide-y divide-purple-400/10">
          {images.map((image) => (
            <tr key={image._id} className="hover:bg-purple-400/5 transition-colors duration-150">
              <td className="p-4">
              ...
              <td className="p-4">
                <select
                  ...
                  value={image.isActive === true ? "active" : "inactive"}
                  onChange={(e) => onStatusChange(image._id, e.target.value as "active" | "inactive")}
                >

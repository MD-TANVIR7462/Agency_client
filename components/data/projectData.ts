...
export const projectsData: Project[] = [
  {
    ...
    description:
      "The Best Software Development Agency Continually strategize standards compliant ideas rather than performance based alignments. Globally leverage existing alternative solutions through virtual users.The Best Software Development Agency Continually strategize standards compliant ideas rather than performance based alignments. Globally leverage existing alternative solutions through virtual users.",
  ...
  },
  {
    ...
    category: "Web Development",
    description:
      "The Best Software Development Agency Continually strategize standards compliant ideas rather than performance based alignments. Globally leverage existing alternative solutions through virtual users.",
